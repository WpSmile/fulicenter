...
public class OkHttpUtils1<T> {
     ...
     */
    public OkHttpUtils1(Context context) {
     ...
     * @return
     */
    public OkHttpUtils1<T> connectTimeout(int connectTime) {
        if (mBuilder == null) {
            return this;
        }
     ...
     * @return
     */
    public OkHttpUtils1<T> writeTimeout(int writeTimeout) {
        if (mBuilder == null) {
            return this;
        }
     ...
     * @return
     */
    public OkHttpUtils1<T> readTimeout(int readTimeout) {
        if (mBuilder == null) {
            return this;
        }
     ...
     * @return
     */
    public OkHttpUtils1<T> cache(File file, int fileSize) {
        if (mBuilder == null) {
            return this;
        }
     ...
     * @return
     */
    public OkHttpUtils1<T> addFile(File file) {
     ...
     * @return
     */
    public OkHttpUtils1<T> addFile(String type, File file) {
        mFileBody = RequestBody.create(MediaType.parse(type), file);
        return this;
    }

    public OkHttpUtils1<T> addFile2(File file) {
        if (mUrl == null) {
            return this;
        }
    ...
    public OkHttpUtils1<T> url(String url) {
        mUrl = new StringBuilder(url);
        return this;
    }

    public OkHttpUtils1<T> setRequestUrl(String request) {
...
//        Log.e("okhttp","1 murl="+ mUrl.toString());
     ...
     * @return
     */
    public OkHttpUtils1<T> targetClass(Class<T> clazz) {
        mClazz = clazz;
        return this;
    }
     ...
     * @param value：值
     */
    public OkHttpUtils1<T> addParam(String key, String value) {
        try {
     ...
     * @return
     */
    public OkHttpUtils1<T> addFormParam(String key, String value) {
     ...
     * @return
     */
    public OkHttpUtils1<T> addFormParam(String name, String fileName, String mediaType, File file) {
        if (mMultipartBodyBuilder == null) {
            return this;
        }
     ...
     * @return
     */
    public OkHttpUtils1<T> doInBackground(Callback callback) {
        mCallback=callback;
        return this;
    }
     ...
     * @return
     */
    public OkHttpUtils1<T> onPostExecute(OnCompleteListener<T> listener) {
        mListener=listener;
        return this;
    }
     ...
     * @return
     */
    public OkHttpUtils1<T> onPreExecute(Runnable r) {
        r.run();
        return this;
    }
